//
//  QHWCycleScrollViewFlowLayout.m
//  QHWCycleScrollView
//
//  Created by cheyr on 2019/2/28.
//  Copyright © 2018年 cheyr. All rights reserved.
//

#import "QHWCycleScrollViewFlowLayout.h"

@implementation QHWCycleScrollViewFlowLayout
...
//    NSArray *arrayAttrs = [super layoutAttributesForElementsInRect:rect];
    ...
    for (UICollectionViewLayoutAttributes *attr in arrayAttrs) {
        // 3.1 计算每个cell的中心点距离
        CGFloat distance = ABS(attr.center.x - centerX);//整数绝对值
        
        // 3.2 距离越大，缩放比越小，距离越小，缩放比越大
        CGFloat factor = 0.001;//0.001
