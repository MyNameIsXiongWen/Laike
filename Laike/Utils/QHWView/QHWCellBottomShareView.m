...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self == [super initWithFrame:frame]) {
        ...
        self.shareBtn = UIButton.btnFrame(CGRectMake(kScreenW-95, 0, 80, 22)).btnCornerRadius(11).btnTitle(@" 微信推广").btnFont(kFontTheme11).btnTitleColor(kColorTheme444).btnImage(kImageMake(@"wechat_share")).btnBorderColor(kColorTheme444).btnAction(self, @selector(clickShareBtn));
