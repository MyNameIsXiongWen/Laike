...
- (IBAction)clickConfirmBtn:(id)sender {
    ...
    [QHWHttpManager.sharedInstance QHW_POST:kMerchantGetCompanyName parameters:@{@"merchantNumber": self.nameTextField.text} success:^(id responseObject) {
        [self showConfirmViewWithName:responseObject[@"data"][@"companyName"]];
